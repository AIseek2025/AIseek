(() => {
    ...
    const boot = async () => {
        ...
        try {
            ...
            await loadScript(`/static/js/app/search.js?${v}`);
            await loadScript(`/static/js/app/profile.js?${v}`);
            mustFn('loadProfile');
            await loadScript(`/static/js/app/creator.js?${v}`);
            await loadScript(`/static/js/app/auth.js?${v}`);
            await loadScript(`/static/js/app/floating_player.js?${v}`);
