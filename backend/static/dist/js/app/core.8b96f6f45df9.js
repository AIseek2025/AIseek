const app = {
    ...
    langMap: {
        ...
        'en': {
            ...
            'upload': 'Create', 'search_ph': 'Search...',
    ...
    applyLanguage: function() {
        ...
        if (upBtn) upBtn.innerHTML = `<i class="fas fa-plus"></i> ${this.t('upload')}`;
    ...
    loadCategories: async function() {
        try {
            const res = await fetch('/api/v1/posts/categories');
    ...
    openPost: async function(postId, opts = {}) {
        ...
        try {
            ...
            this.state.recommendPosts = [post];
            this.renderRecommendPosts([post]);
